...
<section class="section">
    <div class="section-header">
      <h1>Data Makanan</h1>
      <div class="ml-auto">
        <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_makanan"><i class="fa fa-plus"></i> Tambah Makanan</a>
      </div>
    </div>
    ...
    $('#store').click(function(e){
        ...
        $.ajax({
            ...
            error:function(error){
                ...
                if(error.responseJSON && error.responseJSON.nama_makanan && error.responseJSON.nama_makanan[0]){
