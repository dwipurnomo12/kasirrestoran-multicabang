...
<section class="section">
    <div class="section-header">
      <h1>Data Minuman</h1>
      <div class="ml-auto">
        <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_minuman"><i class="fa fa-plus"></i> Tambah Minuman</a>
       </div>
    </div>
    ...
    $('#store').click(function(e){
        ...
        $.ajax({
            ...
            error:function(error){
                ...
                if(error.responseJSON && error.responseJSON.nama_minuman && error.responseJSON.nama_minuman[0]){
    ...
    $('#update').click(function(e){
        ...
        $.ajax({
            ...
            error:function(error){
                ...
                if(error.responseJSON && error.responseJSON.nama_deskripsi && error.responseJSON.nama_deskripsi[0]){
